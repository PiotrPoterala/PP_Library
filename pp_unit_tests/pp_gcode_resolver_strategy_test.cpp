...
//			phyCoord->insert(PParamPair('Z', make_shared<defOParam>("Y", 100000, 0, 999000, 5, 3)));

//			gBasePoints->insert(gBasePoints->begin(), 5, PPpoint<double>(phyCoord->getParamsRealValues()));
//		
